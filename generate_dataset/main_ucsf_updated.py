...
def main():
    ...
    ap.add_argument(
        "-o",
        "--output",
        default="../data/phi_notes_ucsf.json",
    ...
    for fn in phi:
        ...
        # save our notes file
        with open(
            NOTES_FOLDER + fn.split(".")[0] + ".txt", "w", encoding="utf-8"
        ) as note_file:
            note_file.write(txt)
        ...
        with open(
            ANNO_FOLDER + fn.split(".")[0] + ".txt", "w", encoding="utf-8"
        ) as anno_file:
